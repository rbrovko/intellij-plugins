    ...
    public static void smartCheck(
        ...
        try {
            ...
            if (windowDocument != null) {
                ...
                final AnswerPlaceholder userAnswerPlaceholder = usersTaskFile.getAnswerPlaceholders()
                        .get(placeholder.getIndex());
                ...
                if (course != null) {
                    ...
                    StudyTaskManager.getInstance(project)
                            .setStatus(userAnswerPlaceholder, res ? StudyStatus.Solved : StudyStatus.Failed);
